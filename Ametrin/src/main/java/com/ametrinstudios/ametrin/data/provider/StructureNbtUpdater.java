...
//
//    public StructureNbtUpdater(PackOutput output, String modid) {
...
//        this.resources = new MultiPackResourceManager(PackType.SERVER_DATA, List.of(packLoader.openResources(packLocation, packLoader.openMetadata(packLocation).getMetadataSection())));
//    }
//
//    @Override
