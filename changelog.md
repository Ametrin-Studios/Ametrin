...
- (26.1.2) add `ColorCollection` from 26.3 Vanilla
...
- (26.3) disabled tree API (Vanilla tree generation should now be able to do the same)
...
- moved all BlockItemTag rules to `ExtendedBlockItemTagsProvider`
